//will have a detailed table for every work ex and skill gained
        ...
        <div className="min-h-screen bg-black text-white flex flex-col justify-center items-center px-5 relative overflow-hidden">
            ...
            <div className="text-center z-10 max-w-xl">
                ...
                <p className="text-blue-50 text-sm md:text-base mb-10 max-w-md mx-auto leading-relaxed">
                    This section is currently under development. I'm building a deep dive into my skill sets and areas of expertise.
                </p>
...
export default DetailedExpertise;
